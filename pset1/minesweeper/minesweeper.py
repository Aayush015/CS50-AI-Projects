...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        # If total mines is equal to no. of cells, all cells are mines
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # 3
        # Create a set to store cells in the knowledge base
        neighbors = set()
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
        ...
        # 4
        # Collect all neighboring cells that are not already marked safe or mines
        ...
        # Create a new list to store sentences that have non-empty cells
        new_knowledge = []

        # Iterate over each sentence in the KB
        for sentence in self.knowledge:
            # Check if the sentence has any cells
            if sentence.cells:
                # If it does, add it to the new list
                new_knowledge.append(sentence)

        # Update self.knowledge to be the new list
